...
const GITHUB_REPO_URL = "https://github.com/kiaaval/inferex";
const GITHUB_PROFILE_URL = "https://github.com/kiaaval";
const AUTHOR_NAME = "Kia Aval";
      ...
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-5 sm:px-8">
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            aria-label="View the Inferex source on GitHub"
  ...
  return (
    <div className="relative min-h-screen scroll-smooth">
      ...
      >
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <Reveal>
            <div className="flex flex-col items-start justify-between gap-8 rounded-2xl border border-border bg-card p-8 ring-1 ring-foreground/5 sm:p-10 lg:flex-row lg:items-center">
              <div className="max-w-xl">
                <Eyebrow>Open source</Eyebrow>
                <h2 className="mt-3 font-display text-3xl font-semibold tracking-tight sm:text-4xl">
                  Read the code behind the conclusions
                </h2>
                <p className="mt-4 text-muted-foreground">
                  Inferex is a portfolio project by{" "}
                  <a
                  ...
                  . The full source — parser, inference engine, and this
                  interface — is on GitHub.
                </p>
              </div>
              <Button
                variant="outline"
